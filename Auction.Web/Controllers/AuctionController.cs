	...
	public class AuctionController : Controller
	{
		...
		public ActionResult Add(AuctionItemAddModel auctionItem)
		{
			...
			if (ModelState.IsValid)
			{
				...
				MailHelper.SendNewAuctionItemMail(dalEntity.Id);
		...
		public ActionResult Manage(Guid id)
		{
			...
			return View(new AuctionItemManageModel(data));
		}

		[HttpPost]
		public ActionResult Manage(AuctionItemManageModel auctionItem)
		{
			if (MailHelper.SendAuctionEndedMails(auctionItem.Id))
			{
				AuctionItemRepository.Instance.EndAuction(auctionItem.Id);
			}

			return RedirectToAction("Manage", auctionItem.UniqueKey);
		}
